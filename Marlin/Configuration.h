...
#define STRING_CONFIG_H_AUTHOR "Dotdash (JDeW)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3nP"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Ender 3 Stock bed on SKR Mini E3
  // Thick mosfet has more bitty bang
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.4 }
 ...
 *
 */
//#define CUSTOM_Z_MIN_PROBE_PIN
#if ENABLED(CUSTOM_Z_MIN_PROBE_PIN)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 1.0 }
...
#define X_MIN_POS MANUAL_X_HOME_POS //set to minimal point for PnP vision
#define Y_MIN_POS MANUAL_Y_HOME_POS //same as above
#define Z_MIN_POS -2
#define X_MAX_POS X_BED_SIZE //this stays where it is, extra space on X 
#define Y_MAX_POS 220 //Y_BED_SIZE //LIMITED BY TOOL CHANGE 
...
#define PREHEAT_4_LABEL       "Fil Change"
