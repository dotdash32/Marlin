...
#define STRING_CONFIG_H_AUTHOR "Dotdash32 (JDeW)" // Who made the changes.
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { 108, 69 }   // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  24.67,  26.54 }
    #define DEFAULT_Ki_LIST {   2.19,   2.22 }
    #define DEFAULT_Kd_LIST {  69.45,  79.31 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.6, 101.4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.650 }
...
#define XY_PROBE_FEEDRATE (135*60)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     P1_30       // LED driving pin
